...
Dylan authorized Agentready onboarding and configuration. Shopify verification cleared; 34 Concierge decisions are reviewed and saved, but applying them requires approval of Core's 14-day trial followed by $9/month. No trial/charge was started and the app has not applied the setup. See the [setup review and detailed gap report](agentready-setup-and-gaps.md). The actual return terms are in Section 21 of the Terms of Service; native refund/shipping endpoints contain only headings. Public AI discovery files already exist but lack Halfday-specific return/support/Amazon context. The authenticated audit is 80/B with 21 findings and mixed 25/46-product denominators; many findings concern staff merchandise and logistics records rather than consumer tea pages.

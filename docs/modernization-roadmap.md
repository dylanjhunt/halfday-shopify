...
**Latest autonomous pass:** additional homepage native accordion, keyboard-focus and responsive image repairs are audited in the development theme. Seven native legacy redirects are prepared but await an uninterrupted admin import. The [completion decision list](wave-1-completion-questions.md) contains exact catalog, app and editorial questions plus verification evidence. Main remains `bb0169f`.

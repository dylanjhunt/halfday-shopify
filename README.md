...
Latest remaining-work checkpoint: [autonomous completion and decision list](docs/wave-1-completion-questions.md). Homepage keyboard/image repairs are audited in development; the native redirect import is prepared but not submitted.
